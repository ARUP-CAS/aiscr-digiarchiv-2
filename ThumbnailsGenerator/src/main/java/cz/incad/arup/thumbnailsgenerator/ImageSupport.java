...
public class ImageSupport {
    ...
    public static boolean shaChanged(String f, String sha) {
        ...
        try {
            return !sha.equals(FileUtils.readFileToString(shaFile, "UTF-8"));
    ...
    public static void writeSha(String f, String sha) {
        try {
            String dest = getDestDir(f) + "sha.txt";
            File shaFile = new File(dest);
