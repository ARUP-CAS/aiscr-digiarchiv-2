...
//<xs:element name="poznamka" minOccurs="0" maxOccurs="1" type="xs:string"/> <!-- "{poznamka}" -->
    ...
    public void fillSolrFields(SolrInputDocument idoc, String pristupnost) {
        ...
        IndexUtils.addSecuredFieldNonRepeat(idoc, "lokalita_popis", popis, pristupnost);
        IndexUtils.addSecuredFieldNonRepeat(idoc, "lokalita_poznamka", poznamka, pristupnost);
